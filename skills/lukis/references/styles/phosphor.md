...
```text
LINE LANGUAGE: draw EVERYTHING — mascot, objects, arrows — as crisp PHOSPHOR vector strokes of one even weight, glowing softly against the dark screen like an osclukisscope trace; the glow is a tight halo, the line itself stays sharp.
...
Calibration example (not bundled — fetch the URL): https://raw.githubusercontent.com/madearga/lukis-skill/main/_assets/lukis/styles/phosphor-spike.png — study it
