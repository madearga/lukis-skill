...
in sablon, riso, woodcut, clay, or whichever style the character already wears.
...
2. Pick ONE stage this body can actually operate. Examples: Ciko
...
mascot or props to fill the banner. Generate the banner through the normal `lukis.py generate` pipeline;
