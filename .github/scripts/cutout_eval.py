#!/usr/bin/env python3
"""Evaluate lukis's cutout workflow across backends/models/methods.
...
def analyze_image(path):
    ...
    return lukis.analyze_cutout_alpha(data)
...
def main():
    ...
    html_path = build_html(run_dir, results, EVAL_TITLE)
    dest = REPO / "_assets/lukis" / EVAL_ASSET_SLUG
